...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 07 dec 2024 om 17:27
...
CREATE TABLE `pizzas` (
  ...
  `status` enum('concept','op voorraad','niet-op voorraad') DEFAULT 'op voorraad',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `pizzas` (`id`, `name`, `description`, `price`, `in_stock`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Margherita', 'Tomaat, mozzarella, basilicum', 8.99, 1, 'op voorraad', '2024-12-03 20:26:30', '2024-12-03 20:26:30');
...
--
-- AUTO_INCREMENT voor een tabel `ingredient_pizza`
--
ALTER TABLE `ingredient_pizza`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ingredient_pizza`
  ADD CONSTRAINT `ingredient_pizza_ibfk_1` FOREIGN KEY (`pizza_id`) REFERENCES `pizzas` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ingredient_pizza_ibfk_2` FOREIGN KEY (`ingredient_id`) REFERENCES `ingredients` (`id`) ON DELETE CASCADE;

--
-- Beperkingen voor tabel `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`pizza_id`) REFERENCES `pizzas` (`id`) ON DELETE CASCADE;
COMMIT;
